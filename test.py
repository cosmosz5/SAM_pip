...
inst = 'JWST' 
arrname = 'DATA' ## This could be DATA or SIM. Use DATA for real data taken with the selected instrument
rotation_angle = 0.0 ### In case the mask is not propely aligned with the position indicated in the manual
oversample = 1.0 ## Number of times that you want to oversample the data. The default value is the unity
